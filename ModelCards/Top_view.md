# Model Card: Multi-Animal Fish Pose Estimation (Top-View)
...
## Task
This model performs multi-animal pose estimation from video, detecting and tracking predefined body parts of a cleaner fish (*Labroides dimidiatus*) and a client fish from top-view aquarium recordings.  
...
## Limitations
- Trained exclusively on top-view recordings; performance may degrade for front-view or angled cameras
