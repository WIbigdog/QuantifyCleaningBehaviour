...
## All data obtained from tracking from DeepLabCut is provided [here](/VideoData/tracks).

## The code used for post processing data, calculations and plots are presented [here](/Code).
